    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar color="">
        <Toolbar>
          ...
          <CustomButtons variant="contained" color="success" size="medium" onClick={homebuttonClick}>HOME</CustomButtons>
          <CustomButtons variant="contained" color="success" size="medium" onClick={homebuttonClick}>PRODUCTOS</CustomButtons>
          <CustomButtons variant="contained" color="success" size="medium" >VENDEDORES</CustomButtons>
        <CustomButtons variant="contained" color="success" size="medium" onClick={loginbuttonClick}>LOGIN</CustomButtons>
        </Toolbar>
      </AppBar>
    </Box>
