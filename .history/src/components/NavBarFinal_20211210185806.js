...
export function NavBarFinal() {
  ...
  const ProductosClick = (event)=>{
    event.preventDefault()
    window.location.pathname="citySelect"
  }
    ...
    <Box sx={{ flexGrow: 1, padding: 1 }}>
      <AppBar position="static" color="">
        <Toolbar sx={{ flexGrow: 1, padding: 1 }}>
          ...
          <CustomButtons variant="contained" size="medium"  onClick={homebuttonClick}>PRODUCTOS</CustomButtons>
          ...
          <IconButton padding="1" onClick={AboutUsClick}>
              <InfoIcon sx={{ fontSize: 35, color: '#27b32e'}} />
