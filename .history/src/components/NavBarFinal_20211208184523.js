    ...
    <Box sx={{ flexGrow: 1, padding: 1 }}>
      <AppBar position="static" color="">
        <Toolbar>
          ...
          <CustomButtons  size="medium" onClick={homebuttonClick}>HOME</CustomButtons>
          <CustomButtons  size="medium" >PRODUCTOS</CustomButtons>
          <CustomButtons variant="contained" size="medium" >VENDEDORES</CustomButtons>
