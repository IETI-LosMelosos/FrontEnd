            ...
            {products.map(({ image, name, price,description, producedBy, id, img_presentation, city, presentation, phone, SKU}) => (
              <div className="col-md-2" key={id} height="10%" width="10%" >
                ...
                <div className="row" style={{textAlign:'center'}}>
                    <div><button className="shoppingCar3" onClick={() => historiasBtn(id)}>Producido por</button></div>
                    
                    <div></div><button className="shoppingCar2" onClick={() => agregar_carrito(id)}>Agregar</button>
                </div>
