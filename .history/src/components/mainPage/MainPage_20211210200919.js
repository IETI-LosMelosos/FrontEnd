                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <center>
                                ...
                                <br/>
                                <input onChange={change} id="quantityProduct" placeholder="Cantidad" type="number" pattern="^[0-9]" min="1" step="1"/><span style={{marginLeft:'20px',fontSize:'20px'}}>Unidades Especificadas</span>
                            </center>
                        </div>
                    </div>
                    <div className="row" style={{textAlign:'center'}}>
