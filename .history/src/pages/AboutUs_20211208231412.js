...
export function AboutUs() {
  ...
  return (
    <Box fullwidht sx={{padding: 1, margin: 1, alignItems: 'center'}}>
      ...
      <CustomTypography sx={{border: 5,}}>Es un emprendimiento fundado por estudiantes de la Escuela Colombiana de Ingenieria Julio Garavito con la intencion de ayudar a conectar al campo colombiano con sus ciudadanos y de esta manera apoyar al campesino mas directamente.</CustomTypography>
