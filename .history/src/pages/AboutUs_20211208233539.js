...
export function AboutUs() {
  ...
  return (
    <Box fullwidht sx={{display: 'flex',flexGrow: 1,alignItems: 'center', justifyContent:'center',padding: 1, margin: 1 }}>
      <Box fullwidht>
        <img  src={logo} alt="E-SUMERCE"  className={classes.logo} />
      </Box>
      
      <CustomTypography fullwidht sx={{border: 5,padding:2}}>Es un emprendimiento fundado por estudiantes de la Escuela Colombiana de Ingenieria Julio Garavito con la intencion de ayudar a conectar al campo colombiano con sus ciudadanos y de esta manera apoyar al campesino mas directamente.</CustomTypography>
