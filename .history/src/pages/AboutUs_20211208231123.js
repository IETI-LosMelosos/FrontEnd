...
export function AboutUs() {
  ...
  return (
    <Box fullwidht sx={{padding: 1, margin: 1, alignItems: 'center'}}>
      ...
      <CustomTypography fontSize='5060'>Unete a nosotros y apoya el campo colombiano</CustomTypography>
      ...
      <CustomTypography> Comienza apoyando nuestro campo</CustomTypography>
