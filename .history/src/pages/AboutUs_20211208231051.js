...
export function AboutUs() {
  ...
  return (
    <Box fullwidht sx={{padding: 1, margin: 1, alignItems: 'center'}}>
      ...
      <CustomTypography>Es un emprendimiento fundado por estudiantes de la Escuela Colombiana de Ingenieria Julio Garavito con la intencion de ayudar a conectar al campo colombiano con sus ciudadanos y de esta manera apoyar al campesino mas directamente.</CustomTypography>
      <CustomTypography>Unete a nosotros y apoya el campo colombiano</CustomTypography>
      ...
      <TypograCustomTypographyphy> Comienza apoyando nuestro campo</TypograCustomTypographyphy>
