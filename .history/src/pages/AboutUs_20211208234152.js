...
export function AboutUs() {
  ...
  return (
    <Box fullwidht sx={{flexGrow: 1,alignItems: 'center', justifyContent:'center',padding: 1, margin: 1 }}>
      <Box fullwidht sx={{display: 'flex',alignItems: 'center', justifyContent:'center',padding: 1 }}>
      ...
      <ImageList sx={{ border: 2,width: 500, height: 450,display: 'flex',alignItems: 'center', justifyContent:'center',padding: 1 }} cols={3} rowHeight={164}>
      {itemData.map((item) => (
